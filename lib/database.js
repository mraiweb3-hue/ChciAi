...
export async function createClient(clientData) {
  ...
  const client = {
    ...
    openclawPort: 8000 + clients.size + 1, // Simple port assignment
    openclawUrl: null, // Will be set after installation
  ...
  client.openclawUrl = `http://46.28.111.185:${client.openclawPort}`
